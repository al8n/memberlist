    ...
    paste::paste! {
      $(
        ...
        fn [< proto_encoder_decoder_multiple_message_with_ $name:snake _decoder_skip_label_check_on _ $id:snake _ $addr:snake _fuzzy >](
          ...
          encode_decode_messages(false, checksum_algo, compress_algo,  messages, Label::try_from("test").unwrap(), false)
        }
        ...
        fn [< proto_encoder_decoder_single_message_with_ $name:snake _decoder_skip_label_check_on _ $id:snake _ $addr:snake _fuzzy >](
          ...
          encode_decode_message(false, checksum_algo, compress_algo,  message, Label::try_from("test").unwrap(), false)
        }
        ...
        #[cfg(feature = "rayon")]
        #[quickcheck_macros::quickcheck]
        fn [< proto_encoder_parchecksum_and_compressionel_decoder_multiple_message_with_ $name:snake _decoder_skip_label_check_on _ $id:snake _ $addr:snake _fuzzy >](
          checksum_algo: ChecksumAlgorithm,
          compress_algo: CompressAlgorithm,

          messages: Vec<Message<$id, $addr>>
        ) -> bool {
          encode_decode_messages(true, checksum_algo, compress_algo,  messages, Label::try_from("test").unwrap(), false)
        }
        ...
        #[cfg(feature = "rayon")]
        #[quickcheck_macros::quickcheck]
        fn [< proto_encoder_parchecksum_and_compressionel_decoder_single_message_with_ $name:snake _decoder_skip_label_check_on _ $id:snake _ $addr:snake _fuzzy >](
          checksum_algo: ChecksumAlgorithm,
          compress_algo: CompressAlgorithm,

          message: Message<$id, $addr>,
        ) -> bool {
          encode_decode_message(true, checksum_algo, compress_algo,  message, Label::try_from("test").unwrap(), false)
        }
      )*
    }
  };
