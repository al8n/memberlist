...
use memberlist_net::{
  ...
  tests::{promised_ping::*, NetTransporTestPromisedClient},
};
...
unit_tests_with_expr!(run(
  ...
  v4_promised_ping_compression_only({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V4;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
  ...
  #[cfg(feature = "compression")]
  v6_promised_ping_compression_only({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V6;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
...
unit_tests_with_expr!(run(
  ...
  v4_promised_ping_encryption_only({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V4;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
  ...
  #[cfg(feature = "encryption")]
  v6_promised_ping_encryption_only({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V6;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
...
unit_tests_with_expr!(run(
  #[cfg(feature = "encryption")]
  v4_promised_ping_label_and_encryption({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V4;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
  ...
  #[cfg(feature = "encryption")]
  v6_promised_ping_label_and_encryption({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V6;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
...
unit_tests_with_expr!(run(
  #[cfg(feature = "compression")]
  v4_promised_ping_label_and_compression({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V4;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
  ...
  #[cfg(feature = "compression")]
  v6_promised_ping_label_and_compression({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V6;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
...
unit_tests_with_expr!(run(
  v4_promised_ping_no_label_no_compression_no_encryption({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V4;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
  ...
  v6_promised_ping_no_label_no_compression_no_encryption({
    let s = Tcp::<TokioRuntime>::new();
    let kind = AddressKind::V6;
    let c = Tcp::<TokioRuntime>::new();
    let client_addr = kind.next();
