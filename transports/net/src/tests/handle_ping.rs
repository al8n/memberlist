...
/// With label, no compression, with encryption
pub mod with_label_no_compression_with_encryption;

/// With label, with compression, no encryption
pub mod with_label_with_compression_no_encryption;

/// With label, with compression, with encryption
pub mod with_label_with_compression_with_encryption;
