  ...
  R: Runtime,
{
  ...
  let mut opts = NetTransportOptions::<_, _, S>::new(format!("{kind}_ping_server_no_label_no_compression_with_encryption_client_no_label_no_compression_no_encryption").into(), s)
  ...
  R: Runtime,
{
  ...
  let mut opts = NetTransportOptions::<_, _, S>::new(format!("{kind}_ping_server_no_label_no_compression_no_encryption_client_no_label_no_compression_with_encryption").into(), s)
    .with_primary_key(Some(pk))
    .with_encryption_algo(Some(EncryptionAlgo::PKCS7))
  ...
  R: Runtime,
{
  ...
  let mut opts = NetTransportOptions::<_, _, S>::new(format!("{kind}_ping_server_no_label_no_compression_with_encryption_client_no_label_no_compression_with_encryption").into(), s)
    .with_primary_key(Some(pk))
    .with_encryption_algo(Some(EncryptionAlgo::PKCS7))
    .with_gossip_verify_outgoing(true);
  opts.add_bind_address(kind.next(0));
