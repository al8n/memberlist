...
pub struct NetTransport<I, A, R: Runtime> {
  ...
  udp_listener: Arc<<Self as Transport>::PacketStream>,
  wg: AsyncWaitGroup,
...
impl<I: Id, A: AddressResolver, R: Runtime> Transport for NetTransport<I, A, R> {
