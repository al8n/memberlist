...
pub async fn server_no_label_no_compression_client_no_label_no_compression<
  S,
  R,
>(
  s: S,
...
{
  let mut opts = QuicTransportOptions::new(format!("{kind}_ping_server_no_label_no_compression_client_no_label_no_compression").into());
