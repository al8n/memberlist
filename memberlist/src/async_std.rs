...
pub type AsyncStdTcpMemberlist<I, A, D> = memberlist_core::Memberlist<
...
pub type AsyncStdTlsMemberlist<I, A, D> = memberlist_core::Memberlist<
  memberlist_net::NetTransport<
    I,
    A,
...
pub type AsyncStdQuicMemberlist<I, A, D> = memberlist_core::Memberlist<
