...
#[cfg(all(any(feature = "tcp", feature = "tls", feature = "native-tls"), not(target_family = "wasm")))]
#[cfg_attr(docsrs, doc(cfg(all(any(feature = "tcp", feature = "tls", feature = "native-tls"), not(target_family = "wasm")))))]
pub type TokioTcpMemberlist<I, A, W, D> = memberlist_core::Memberlist<
  memberlist_net::NetTransport<I, A, memberlist_net::stream_layer::tcp::Tcp<TokioRuntime>, W, TokioRuntime>,
  D,
>;
...
pub type TokioTlsMemberlist<I, A, W, D> = memberlist_core::Memberlist<
  memberlist_net::NetTransport<I, A, memberlist_net::stream_layer::tls::Tls<TokioRuntime>, W, TokioRuntime>,
  D,
>;
...
#[cfg_attr(docsrs, doc(cfg(all(feature = "native-tls", not(target_family = "wasm")))))]
pub type TokioNativeTlsMemberlist<I, A, W, D> = memberlist_core::Memberlist<
  memberlist_net::NetTransport<I, A, memberlist_net::stream_layer::native_tls::NativeTls<TokioRuntime>, W, TokioRuntime>,
  D,
>;
...
pub type TokioQuicMemberlist<I, A, W, D> = memberlist_core::Memberlist<
  memberlist_quic::QuicTransport<I, A, memberlist_quic::stream_layer::quinn::Quinn<TokioRuntime>, W, TokioRuntime>,
  D,
>;
...
pub type TokioS2nMemberlist<I, A, W, D> = memberlist_core::Memberlist<
  memberlist_quic::QuicTransport<I, A, memberlist_quic::stream_layer::s2n::S2n<TokioRuntime>, W, TokioRuntime>,
  D,
>;