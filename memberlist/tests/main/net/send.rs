    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _send_with_checksum >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_send::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, Options::lan().with_checksum_algo(Some(Default::default())).with_offload_size(10), t2_opts, Options::lan().with_checksum_algo(Some(Default::default())).with_offload_size(10)).await;
        });
      }
      ...
      fn [< test_ $rt:snake _ $kind:snake _send_with_compression >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_send::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, Options::lan().with_compress_algo(Some(Default::default())).with_offload_size(10), t2_opts, Options::lan().with_compress_algo(Some(Default::default())).with_offload_size(10)).await;
        });
      }
