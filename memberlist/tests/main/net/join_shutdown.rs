    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _join_shutdown >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_join_shutdown::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, Lpe<_, _>, [< $rt:camel Runtime >]>, _>(t1_opts, Options::lan(), t2_opts, Options::lan()).await;
        });
      }
    }
  };
