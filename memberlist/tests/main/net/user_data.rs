...
macro_rules! user_data {
  ($layer:ident<$rt: ident> ($kind:literal, $expr: expr)) => {
    paste::paste! {
      ...
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _user_data_with_checksum >]() {
        [< $rt:snake _run >](async move {
          let mut t1_opts = NetTransportOptions::<SmolStr, _, $layer<[< $rt:camel Runtime >]>>::with_stream_layer_options("user_data_node_1".into(), $expr);
          t1_opts.add_bind_address(next_socket_addr_v4(0));
          ...
          memberlist_user_data::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, opts1.with_checksum_algo(Some(Default::default())).with_offload_size(10), t2_opts, Options::lan().with_checksum_algo(Some(Default::default())).with_offload_size(10)).await;
        });
      }
      ...
      fn [< test_ $rt:snake _ $kind:snake _user_data_with_compression >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_user_data::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, opts1.with_compress_algo(Some(Default::default())).with_offload_size(10), t2_opts, Options::lan().with_compress_algo(Some(Default::default())).with_offload_size(10)).await;
        });
      }
      ...
      fn [< test_ $rt:snake _ $kind:snake _user_data_with_encryption >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_user_data::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, opts1, t2_opts, opts2).await;
        });
      }
      ...
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _user_data_with_all >]() {
        [< $rt:snake _run >](async move {
          let mut t1_opts = NetTransportOptions::<SmolStr, _, $layer<[< $rt:camel Runtime >]>>::with_stream_layer_options("user_data_node_1".into(), $expr);
          t1_opts.add_bind_address(next_socket_addr_v4(0));
