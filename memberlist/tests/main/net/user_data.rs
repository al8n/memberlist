    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _user_data_with_checksum >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_user_data::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, opts1.with_checksum_algo(Default::default()).with_offload_size(10), t2_opts, Options::lan().with_checksum_algo(Default::default()).with_offload_size(10)).await;
        });
      }
      ...
      fn [< test_ $rt:snake _ $kind:snake _user_data_with_compression >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_user_data::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, opts1.with_compress_algo(Default::default()).with_offload_size(10), t2_opts, Options::lan().with_compress_algo(Default::default()).with_offload_size(10)).await;
        });
      }
