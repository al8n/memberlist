...
use memberlist_net::{security::SecretKey, Label};
...
mod tokio {
  ...
  join_with_labels_and_encryption!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  join_with_labels_and_encryption!(tokio(
    "tls",
...
mod async_std {
  ...
  join_with_labels_and_encryption!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  join_with_labels_and_encryption!(async_std(
    "tls",
...
mod smol {
  ...
  join_with_labels_and_encryption!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  join_with_labels_and_encryption!(smol(
    "tls",
