    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _join_cancel >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_join_cancel::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, Options::lan(), t2_opts, Options::lan()).await;
        });
      }
      ...
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _join_cancel_with_checksum >]() {
        [< $rt:snake _run >](async move {
          let mut t1_opts = NetTransportOptions::<SmolStr, _, $layer<[< $rt:camel Runtime >]>>::with_stream_layer_options("join_cancel_node_1".into(), $expr);
          t1_opts.add_bind_address(next_socket_addr_v4(0));
          ...
          memberlist_join_cancel::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, Options::lan().with_compress_algo(Some(Default::default())), t2_opts, Options::lan().with_compress_algo(Some(Default::default()))).await;
        });
      }
      ...
      fn [< test_ $rt:snake _ $kind:snake _join_cancel_with_encryption >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_join_cancel::<NetTransport<_, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, opts1, t2_opts, opts2).await;
        });
      }
      ...
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _join_cancel_with_all >]() {
        [< $rt:snake _run >](async move {
          let mut t1_opts = NetTransportOptions::<SmolStr, _, $layer<[< $rt:camel Runtime >]>>::with_stream_layer_options("join_cancel_node_1".into(), $expr);
          t1_opts.add_bind_address(next_socket_addr_v4(0));
