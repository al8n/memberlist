...
macro_rules! suspect_node_refute {
  ($rt: ident ($kind:literal, $expr: expr)) => {
    paste::paste! {
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _net_suspect_node_refute >]() {
...
mod tokio {
  ...
  suspect_node_refute!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  suspect_node_refute!(tokio(
    "tls",
...
mod async_std {
  ...
  suspect_node_refute!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  suspect_node_refute!(async_std(
    "tls",
...
mod smol {
  ...
  suspect_node_refute!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  suspect_node_refute!(smol(
    "tls",
