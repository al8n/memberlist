    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _probe_node_awareness_improved >]() {
        [< $rt:snake _run >](async move {
          ...
          probe_node_awareness_improved(t1, Options::lan(), t2, Options::lan()).await;
        });
      }
      ...
      fn [< test_ $rt:snake _ $kind:snake _probe_node_awareness_improved_with_compression >]() {
        [< $rt:snake _run >](async move {
          ...
          probe_node_awareness_improved(t1, opts1, t2, opts2).await;
        });
      }
      ...
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _probe_node_awareness_improved_with_all >]() {
        [< $rt:snake _run >](async move {
          let mut t1_opts = NetTransportOptions::<SmolStr, _, $layer<[< $rt:camel Runtime >]>>::with_stream_layer_options("probe_node_awareness_improved_1".into(), $expr);
          t1_opts.add_bind_address(next_socket_addr_v4(0));
