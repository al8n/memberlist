    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _node_delegate_meta_with_compression >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_node_delegate_meta::<QuicTransport<SmolStr, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, Options::lan().with_compress_algo(Default::default()), t2_opts, Options::lan().with_compress_algo(Default::default())).await;
        });
      }
    }
  };
