...
mod tokio {
  ...
  dead_node_alive_replay!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_alive_replay!(tokio(
    "tls",
...
mod async_std {
  ...
  dead_node_alive_replay!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_alive_replay!(async_std(
    "tls",
...
mod smol {
  ...
  dead_node_alive_replay!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_alive_replay!(smol(
    "tls",
