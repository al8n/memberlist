...
mod tokio {
  ...
  alive_node_new_node!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  alive_node_new_node!(tokio(
    "tls",
...
mod async_std {
  ...
  alive_node_new_node!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  alive_node_new_node!(async_std(
    "tls",
...
mod smol {
  ...
  alive_node_new_node!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  alive_node_new_node!(smol(
    "tls",
