...
macro_rules! dead_node_double {
  ($rt: ident ($kind:literal, $expr: expr)) => {
    paste::paste! {
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _net_dead_node_double >]() {
...
mod tokio {
  ...
  dead_node_double!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_double!(tokio(
    "tls",
...
mod async_std {
  ...
  dead_node_double!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_double!(async_std(
    "tls",
...
mod smol {
  ...
  dead_node_double!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_double!(smol(
    "tls",
