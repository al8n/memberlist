...
mod tokio {
  ...
  alive_node_idempotent!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  alive_node_idempotent!(tokio(
    "tls",
...
mod async_std {
  ...
  alive_node_idempotent!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  alive_node_idempotent!(async_std(
    "tls",
...
mod smol {
  ...
  alive_node_idempotent!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  alive_node_idempotent!(smol(
    "tls",
