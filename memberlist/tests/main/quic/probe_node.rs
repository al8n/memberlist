    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _probe_node >]() {
        [< $rt:snake _run >](async move {
          ...
          probe_node(t1, t1_opts, t2, Options::lan()).await;
        });
      }
      ...
      fn [< test_ $rt:snake _ $kind:snake _probe_node_with_compression >]() {
        [< $rt:snake _run >](async move {
          ...
          t2_opts.add_bind_address(next_socket_addr_v4(0));
          let t2 = QuicTransport::new(t2_opts).await.unwrap();
          probe_node(t1, Options::lan().with_compress_algo(Some(Default::default())), t2, Options::lan().with_compress_algo(Some(Default::default()))).await;
        });
      }
    }
  };
