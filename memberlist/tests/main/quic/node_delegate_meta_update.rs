    ...
    paste::paste! {
      ...
      fn [< test_ $rt:snake _ $kind:snake _node_delegate_meta_update >]() {
        [< $rt:snake _run >](async move {
          ...
          memberlist_node_delegate_meta_update::<QuicTransport<SmolStr, SocketAddrResolver<[< $rt:camel Runtime >]>, _, [< $rt:camel Runtime >]>, _>(t1_opts, opts, t2_opts, Options::lan()).await;
        });
      }
