...
macro_rules! dead_node_old_dead {
  ($rt: ident ($kind:literal, $expr: expr)) => {
    paste::paste! {
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _net_dead_node_old_dead >]() {
...
mod tokio {
  ...
  dead_node_old_dead!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_old_dead!(tokio(
    "tls",
...
mod async_std {
  ...
  dead_node_old_dead!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_old_dead!(async_std(
    "tls",
...
mod smol {
  ...
  dead_node_old_dead!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  dead_node_old_dead!(smol(
    "tls",
