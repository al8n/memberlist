...
macro_rules! probe_node_awareness_missed_nack {
  ($rt: ident ($kind:literal, $expr: expr)) => {
    paste::paste! {
      #[test]
      fn [< test_ $rt:snake _ $kind:snake _net_probe_node_awareness_missed_nack >]() {
...
mod tokio {
  ...
  probe_node_awareness_missed_nack!(tokio("tcp", Tcp::<TokioRuntime>::new()));

  #[cfg(feature = "tls")]
  probe_node_awareness_missed_nack!(tokio(
    "tls",
...
mod async_std {
  ...
  probe_node_awareness_missed_nack!(async_std("tcp", Tcp::<AsyncStdRuntime>::new()));

  #[cfg(feature = "tls")]
  probe_node_awareness_missed_nack!(async_std(
    "tls",
...
mod smol {
  ...
  probe_node_awareness_missed_nack!(smol("tcp", Tcp::<SmolRuntime>::new()));

  #[cfg(feature = "tls")]
  probe_node_awareness_missed_nack!(smol(
    "tls",
