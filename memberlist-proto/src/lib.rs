...
pub use quic::{
  ...
  DEFAULT_PENDING_SOURCE_PREFIX_V4, DEFAULT_PENDING_SOURCE_PREFIX_V6, DatagramSendStatus,
  MAX_CATCHUP_INTERVAL, QuicEndpoint, QuicOptions, QuicOptionsError, SourcePrefix,
  UnreliableTransport,
};
